...
BOOL installQLGeneratorImpl()
{
    ...
    NSString *dst = [@"~/Library/QuickLook/SeaDriveQL.qlgenerator" stringByExpandingTildeInPath];
...
-(NSDictionary *)handleOneRequest:(NSDictionary *)request
{
    ...
    if (isCmd("getMountPoint")) {
        ...
        // TODO: fetch the real thumbnail from seahub api
        return simpleResponse(@"/data/github/seadrive-gui/qlgen/test.jpg");
    }
